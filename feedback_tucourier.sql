...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2017 a las 14:28:42
...
(2, 2, 1, 'Jean', 35, 2, 105, 0.5, 1.5, 1),
(3, 3, 1, 'Remera', 6.99, 4, 34.95, 0.2, 1, 1),
(4, 3, 2, 'Iphone 6 plus', 750.99, 1, 1501.98, 0.5, 1, 1);
...
(1, 1, 'Apple Store', '0001', 'DHL', 3, 2, '2017-01-20 13:27:43', 4001.98, 2, '0001', 0, 1, 'QATEST.pdf', '/dist/files/1484523667594/9f3d091dddbb30a0127936643ea2591a570574e9ea758e1d1bbbb0c3f0dda570.pdf'),
(2, 1, 'H&M', '0002', 'DHL', 13, 2, '2017-01-20 13:27:44', 139.95, 2.5, '0002', 0, 1, 'QATEST.pdf', '/dist/files/1484523667595/2595ca3d467b0ae1e8d4beae212e600c46d18c8a97fda3c832d20579f2292c21.pdf');
...
(2, 1, 2, 'Iphone 6 plus', 750.99, 2, 1, 1501.98, 1, 0.5, 1, 0),
(3, 2, 1, 'Remera', 6.99, 10, 1, 34.95, 1, 0.2, 1, 0),
(4, 2, 1, 'Jean', 35, 3, 1, 105, 1.5, 0.5, 1, 0);
...
(2, 'Santiago', 'Lloret', NULL, NULL, NULL, '1234', 0, 'santi', '21232f297a57a5a743894a0e4a801fc3', '9a4010031e89c3fbfe0b8e30a80aef21', 1, '12345678', 0, 'tabanera 3385', 'mendoza', '5500', '308192ed9a7cf69af0c004179844ace7', 1475968761, 1, 0, 0),
...
(1, 1, 4176.88, 4176.88, 16, 4, '1484677259 ', 0, '', 0, NULL, 5.7, 0);
...
--
ALTER TABLE `airway_bill_product`
  MODIFY `awb_productId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
