function dragDropDirective(angular, app) {
    ...
    app.factory('dragContext', [function() {
        var context = {};
    ...
    app.run(['$document', '$rootElement', '$timeout', function($document, $rootElement, $timeout) {
         ...
         *
         * Source: https://github.com/webappules/load-styles/blob/master/index.js
         */
    ...
    app.directive('dragContainer', ['$rootElement', '$parse', '$timeout', 'dragContext', function($rootElement, $parse, $timeout, dragContext) {
        return {
            restrict: 'A',
    ...
    app.directive('dropContainer', ['$document', '$parse', '$window', 'dragContext', function($document, $parse, $window, dragContext) {
        return {
            restrict: 'A',
    ...
    app.controller('DropContainerController', [function() {
    ...
    app.directive('dropTarget', ['$parse', 'dragContext', function($parse, dragContext) {
        return {
            restrict: 'A',
