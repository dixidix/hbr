(function () {
	...
	.config(['$stateProvider','$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
		...
		.state('dashboard.checkout', { url: "/myhbr/shopping/checkout", params: { paymentGatewayUrl: null }, templateUrl: "./dist/routes/checkout/checkout.template.html", data: { title: 'Checkout', requireAuth: false }, controller: "checkoutCtrl", controllerAs: "checkout" });
	}])
