...
$body = file_get_contents('./emails/cargar_venta.template.html', FILE_USE_INCLUDE_PATH);
...
$htmlStringToReplace = array('$email','$lote','$name');
 $replaceWith   = array("$email", $lote, "$name");
$body = str_replace($htmlStringToReplace, $replaceWith, $body);

$to = "santiago.lloret@tucourier.com.ar";
$name = "HBR | tu courier";
$subject = "Solicitud de pago lista";
$mail->CharSet = 'UTF-8';
$mail->AddReplyTo($to);
